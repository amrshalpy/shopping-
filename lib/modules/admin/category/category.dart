// import 'dart:io';
// import 'package:e_comarce/modules/admin/category/widgets/get_category.dart';
...
//             ));
//           } else if (HomeLayoutCubit.get(context)
...
//                         child: IconButton(
//                           onPressed: () {
//                             HomeLayoutCubit.get(context).getImage();
//                           },
//                           icon: Icon(Icons.add),
//                         ),
//                       ),
...
//                     item(text: "Description".tr, controller: discController),
//                     item(text: "Details".tr, controller: detailsController),
//                     item(text: "Color".tr, controller: colorController),
...
//                         if (HomeLayoutCubit.get(context).image != null) {
//                           fireStorage.FirebaseStorage.instance
//                               .ref()
//                               .child(
//                                   'Products/${Uri.file(HomeLayoutCubit.get(context).image!.path).pathSegments.last}')
//                               .putFile(
//                                   (HomeLayoutCubit.get(context).image as File))
//                               .then((val) {
...
//                                     ganmingId: "EqGVjYoTDn9NcyxmyXGR",
//                                     WomenId: "ORSIX2UM8iUNba5KknE1");
//                                 HomeLayoutCubit.get(context).image = null;
//                               });
//                             });
//                           });
//                         } else {
...
//   }
//
//   Widget item({text, controller, TextInputType type = TextInputType.text}) =>
//       Column(
//         crossAxisAlignment: CrossAxisAlignment.start,
//         children: [
//           TextFormField(
...
//                   children: [
//                     Container(
//                       child: HomeLayoutCubit.get(context).image == null
//                           ? SizedBox()
//                           : Image(
//                               image: FileImage(
//                                   HomeLayoutCubit.get(context).image as File),
...
//                       height: 15,
//                     ),
//                     item(text: "Name".tr, controller: name),
//                     item(
//                         text: "Price".tr,
//                         controller: price,
//                         type: TextInputType.number),
//                     item(text: "Description".tr, controller: disc),
//                     item(text: "Details".tr, controller: details),
//                     item(text: "Color".tr, controller: Color),
//                     item(text: "Size".tr, controller: size),
//                   ],
//                 ),
//               ),
//               Container(
