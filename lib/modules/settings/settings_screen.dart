...
import 'package:e_comarce/modules/editProfile/edit_profile.dart';
import 'package:e_comarce/modules/login/log_in_screen.dart';
import 'package:e_comarce/modules/order/order_history.dart';
import 'package:e_comarce/modules/shipping/shipping_address.dart';
                    ...
                    CircleAvatar(
                      child: CircleAvatar(
                        child: Container(
                            ...
                            child:CacheHelper.getData(key: "Picture") == ""?
                            Image.network("https://www.iconpacks.net/icons/2/free-user-icon-3297-thumb.png",
                              width: 300,)
                                : Image.network(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text((CacheHelper.getData(key: "Email")),
                              style: GoogleFonts.merriweatherSans(fontSize: 14)),
                          SizedBox(
                            height: 30,
                          ),
                        ],
